...
def write_introduction(doc):
    ...
    para(doc,
            ...
            "diagnostic biomarkers [101]. Studies, such as the GediNET  and CogNet architectures [57,59], "
            ...
            "a typical study collects only a few hundred samples [102].  This disparity, "
    ...
    para(doc,
            ...
            "of relevant features from high-dimensional data [103]. Feature selection methods "
    ...
    para(doc,
            ...
            "grouping to multi-omics breast-cancer data [43,67].  At the ontology level, the "
    ...
    para(doc,
            ...
            "networks. For instance, CogNet utilized KEGG subnetworks [26,59], GeNetOntology "
            "employed Gene Ontology terms [27,65], and GediNET used DisGeNET associations "
            "[28,57]. Later extensions of this paradigm successfully mapped miRNA-target regulatory networks [60,68] and demonstrated broad generalisability to other omics modalities, including gut microbiome data [63,70]. The present study builds upon this lineage, refining the framework into "
            ...
            "could be discovered through the group-scoring mechanism [69].  However, the "
            ...
            "reporting, dual-metric Robust Rank Aggregation [61] (group-derived and model-native), "
...
def write_discussion(doc, perf, val):
    ...
    paras_model = [
        ...
        (
            "GediNET [57] was an early tool to use DisGeNET disease-gene associations as a direct grouping function in the G-S-M framework, and demonstrated that disease-disease associations could be discovered through the group-scoring mechanism [69].  However, the statistical safeguards, multi-seed stability analysis, and automated biological validation pipeline presented here go substantially beyond GediNET's original implementation.  Beyond methodology alone, the present work adds a practical research stack: iterative bootstrap-based uncertainty reporting, dual-metric Robust Rank Aggregation [61] (group-derived and model-native), seed and sensitivity analyses, classifier-selection via biological coherence, knowledge-source comparison, automatic figure and table generation, a rich CLI workflow, a browser-based UI, and portable clinical-inference model bundles."
        ),
        (
